...
fn main() {
    ...
    let loaded_images: Vec<_> = images.iter()
    ...
    println!("{:>8} {:>8} {:>10.0} {:>10.3} {:>10} {:>10} (baseline)",
    ...
    for coupling in couplings {
        for offset in quality_offsets {
            ...
            println!("{:>8.1} {:>8.1} {:>10.0} {:>10.3} {:>+10.1}% {:>+10.1}%{}",
                     coupling, quality, hybrid_size_avg, hybrid_ba_avg, size_delta, ba_delta, pareto_marker);
        }
    }
    ...
    if let Some((c, q_off, sz, ba)) = best_pareto {
        println!("BEST PARETO: aq_lambda_scale={}, Q{} → {:.1}% smaller, {:.1}% better BA",
                 c, base_quality + q_off, sz, ba);
    }
}
