...
fn bench_pre_erosion() {
    ...
    // Warmup
    for _ in 0..10 {
        zenjpeg::quant::aq::simd::pre_erosion_row_padded(
            &row,
            &row_above,
            &row_below,
            WIDTH,
        ...
        zenjpeg::quant::aq::autovec::pre_erosion_row_autovec_iter(
            &row,
            &row_above,
            &row_below,
            WIDTH,
...
fn bench_gamma_hf_modulation() {
    ...
    for bx in 0..10.min(BLOCK_W) {
        ...
        std::hint::black_box(zenjpeg::quant::aq::simd::gamma_modulation_sum_8x8(
            block,
            stride,
            x_start,
            0,
        ...
        std::hint::black_box(
            zenjpeg::quant::aq::autovec::gamma_modulation_sum_8x8_autovec(block, stride, 0, HEIGHT),
        );
    }
    ...
    for _ in 0..ITERS {
        for bx in 0..BLOCK_W {
            ...
            let block = &input[x_start..];
            std::hint::black_box(
                zenjpeg::quant::aq::autovec::gamma_modulation_sum_8x8_autovec(
    ...
    for _ in 0..ITERS {
        for bx in 0..BLOCK_W {
            let x_start = bx * 8;
            let block = &input[x_start..];
            std::hint::black_box(zenjpeg::quant::aq::simd::hf_modulation_sum_8x8(
                block,
                stride,
                x_start,
                0,
    ...
    for _ in 0..ITERS {
        for bx in 0..BLOCK_W {
            let x_start = bx * 8;
            let block = &input[x_start..];
            std::hint::black_box(zenjpeg::quant::aq::autovec::hf_modulation_sum_8x8_autovec(
                block, stride, 0, HEIGHT,
            ));
        }
    }
...
fn bench_per_block_modulations() {
    ...
    for _ in 0..10 {
        ...
        zenjpeg::quant::aq::simd::per_block_modulations_row(
            &input,
            stride,
            BLOCK_W * 8,
            HEIGHT,
        ...
        zenjpeg::quant::aq::autovec::per_block_modulations_row_autovec(
            &input,
            stride,
            BLOCK_W * 8,
            HEIGHT,
