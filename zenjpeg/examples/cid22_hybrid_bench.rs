...
use zenjpeg::hybrid::config::{adaptive_config, detect_image_type, HybridConfig, ImageType};
...
fn main() {
    ...
    println!("{:>30}  {:>6}  {:>6}  {:>8}  {:>8}  {:>8}  {:>8}  {:>8}  {:>8}  {:>8}",
        "Image", "Mean", "CV", "Type", "JpegliB", "HybridB", "ΔSize%", "JpegliBA", "HybridBA", "ΔButter%");
    println!("{:-<30}  {:-<6}  {:-<6}  {:-<8}  {:-<8}  {:-<8}  {:-<8}  {:-<8}  {:-<8}  {:-<8}",
        "", "", "", "", "", "", "", "", "", "");
    ...
    for img_path in images.iter().take(20) {  // Limit to 20 for speed
        let img = match ImageData::from_path(img_path) {
            Some(i) => i,
            None => continue,
        };
        
        let name = img_path.parent().unwrap().file_name().unwrap().to_string_lossy();
        ...
        let jpegli_config = EncoderConfig::ycbcr(85.0, ChromaSubsampling::Quarter)
        ...
        println!("{:>30}  {:>6.3}  {:>6.2}  {:>8}  {:>8}  {:>8}  {:>+8.1}  {:>8.3}  {:>8.3}  {:>+8.1}",
    ...
    if count > 0 {
        ...
        println!("{:-<30}  {:-<6}  {:-<6}  {:-<8}  {:-<8}  {:-<8}  {:-<8}  {:-<8}  {:-<8}  {:-<8}",
            "", "", "", "", "", "", "", "", "", "");
        println!("{:>30}  {:>6}  {:>6}  {:>8}  {:>8}  {:>8}  {:>+8.1}  {:>8.3}  {:>8.3}  {:>+8.1}",
            "AVERAGE",
            "",
            "",
            "",
