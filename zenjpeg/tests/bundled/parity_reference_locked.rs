...
/// 4:4:4 Corpus-Trained Huffman - (quality, rust_size, cpp_size, dssim, butteraugli)
/// Updated 2026-02-01: switched from Annex K to corpus-trained tables (5-11% smaller)
#[rustfmt::skip]
// rust_size relocked 2026-08-26 (73c84c50): fixed-table completion (~240
// bytes fuller DHT; previously-uncovered symbols were silently dropped as
// zero bits). cpp_size and metrics unchanged.
pub const S444_FIXED: &[(u8, usize, usize, f64, f64)] = &[
    (5, 16938, 16179, 0.006057, 4.80000000),
    (10, 19638, 19230, 0.005442, 4.60000000),
    (15, 23482, 23054, 0.004857, 4.40000000),
    (20, 27590, 27062, 0.004352, 4.20000000),
    (25, 31713, 31019, 0.003961, 4.00000000),
    (30, 34690, 33848, 0.003727, 3.80000000),
    (35, 36227, 35351, 0.003624, 3.60000000),
    (40, 37741, 36831, 0.003520, 3.40000000),
    (45, 39976, 38883, 0.003382, 3.20000000),
    (50, 41934, 40752, 0.003253, 3.00000000),
    (55, 43940, 43028, 0.003111, 2.80000000),
    (60, 47034, 46246, 0.002963, 2.60000000),
    (65, 50345, 49393, 0.002807, 2.40000000),
    (70, 55064, 53870, 0.002644, 2.20000000),
    (75, 60275, 58935, 0.002481, 2.00000000),
    (80, 67598, 66177, 0.002273, 1.80000000),
    (85, 78641, 76758, 0.002023, 1.60000000),
    (90, 97522, 95490, 0.001660, 1.40000000),
    (95, 138331, 134545, 0.001187, 1.20000000),
    (100, 336124, 323934, 0.000313, 1.00000000),
];
