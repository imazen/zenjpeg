...
<?xpacket end="w"?>"#;
    ...
    fn native_metadata_compatible_with_ultrahdr() {
        use zenjpeg::ultrahdr::jpeg::parse_jpeg_segments;
...
mod ultrahdr_tests {
    use super::*;
    use zenjpeg::ultrahdr::jpeg::parse_jpeg_segments;
    use zenjpeg::ultrahdr::metadata::xmp::{create_xmp_app1_marker, generate_xmp};
    use zenjpeg::ultrahdr::GainMapMetadata;
    ...
    fn segment_reconstruction_preserves_jpegli_data() {
        use zenjpeg::ultrahdr::jpeg::reconstruct_jpeg;
    ...
    fn ultrahdr_segment_injection_workflow() {
        use zenjpeg::ultrahdr::jpeg::{insert_segment_after_soi, JpegSegment};
