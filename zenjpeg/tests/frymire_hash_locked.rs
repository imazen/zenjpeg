...
const EXPECTED_HASHES: &[(&str, u8, &str, usize)] = &[
    ...
    (
        "baseline_444_fixed",
        50,
        "b599810ae589091e18e7d1483cf705f594275b8509ae35d58d2382c9a62f969b",
        342239,
    ),
    (
        "baseline_444_fixed",
        75,
        "3f99ceb982da96f2e144d8a1ba24ff38ac26964a6882090508a26f3023725d53",
        493912,
    ),
    (
        "baseline_444_fixed",
    ...
    (
        "progressive_444_opt",
        50,
        "62f422ab0b6854387100602455728ec8981bf5823c52cdc48521919de5aad4a7",
        318025,
    ),
    (
        "progressive_444_opt",
        75,
        "6b17a774c252466579ed718f7994fbbdc51ce4b9c2343228098dc2285befb3f4",
        459677,
    ),
    (
        "progressive_444_opt",
    ...
    (
        "progressive_420_opt",
        50,
        "314f7b50e533f497e57d8df0dceb579a4c623ec47871b6871a024a786e476537",
        259054,
    ),
    (
        "progressive_420_opt",
    ...
    (
        "baseline_xyb_fixed",
        50,
        "6b4aa15f1cd5c71a28215e4a585365873bec48abead1aeaaf3e51e55dcb8cb94",
        299243,
    ),
    (
        "baseline_xyb_fixed",
        75,
        "6445c439297f251b7630c07dbba4c10ae664d8a448b60f10fcf357d2ffd33210",
        415103,
    ),
    (
        "baseline_xyb_fixed",
        90,
        "bf33e832d1d78829d7a95fe39402ea8684d7528d359d474c7395ed0a1dd88343",
        627566,
    ),
    (
        "progressive_xyb_opt",
        50,
        "7a7f9be701b81d3c9cdc8cfbf71558be2eec5e2126ee3c2016da2b2eeaaca430",
        277113,
    ),
    (
        "progressive_xyb_opt",
        75,
        "48f079d48922f54995d48c19cd4f3ba059add6d281d66afe22b02dc15d48443c",
        389133,
    ),
    (
        "progressive_xyb_opt",
        90,
        "264acdc7cb4923ca3f2b571b1694caa338394a12b36c45006d087b9de4319cc9",
        578615,
    ),
];
...
const EXPECTED_HASHES: &[(&str, u8, &str, usize)] = &[
    ...
    (
        "baseline_444_fixed",
        75,
        "7b3e4e481638b82f591d435f8d5626589faa4544909598fee02fae4030016068",
        493912,
    ),
    (
        "baseline_444_fixed",
        90,
        "ea56a8ffd0992d0ef0363b3e0801d520a84bb75ef26b6fbe62d58e4c7130c423",
        764361,
    ),
    (
        "baseline_420_opt",
    ...
    (
        "progressive_444_opt",
        75,
        "ad297f62f3efb8eef0fe424b1fa81ed7502a48534f3c7eda3ba891f266cf7005",
        459677,
    ),
    (
        "progressive_444_opt",
