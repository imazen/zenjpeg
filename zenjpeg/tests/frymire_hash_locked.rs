...
const EXPECTED_HASHES: &[(&str, u8, &str, usize)] = &[
    ...
    // XYB expected values updated after AQ v_samp fix for XYB mode (2026-01-31)
    // Fix: XYB uses R:2×2 G:2×2 B:1×1, so max_v_samp_factor=2, not 1
    (
        "baseline_xyb_opt",
        50,
    ...
    (
        "baseline_xyb_fixed",
        50,
        "489dfd6140454e1598f40f86000963fcd1a316cea49f173dd84b2670218f3b80",
        299371,
    ),
    (
        "baseline_xyb_fixed",
    ...
    (
        "progressive_xyb_opt",
        50,
        "9534f63bc416e66fb7ddf715026bd55236e0f8beacffacb4084c0871bc6a0c31",
        277241,
    ),
    (
        "progressive_xyb_opt",
