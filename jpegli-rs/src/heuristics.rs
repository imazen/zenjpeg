...
//!
//! ```rust,ignore
//! use jpegli::heuristics::{estimate_encode, estimate_decode};
...
///
/// ```rust,ignore
/// use jpegli::heuristics::estimate_encode;
/// use jpegli::encoder::{EncoderConfig, ChromaSubsampling};
///
/// let config = EncoderConfig::ycbcr(85, ChromaSubsampling::Quarter);
...
///
/// ```rust,ignore
/// use jpegli::heuristics::estimate_encode_ceiling;
/// use jpegli::encoder::{EncoderConfig, ChromaSubsampling};
///
/// let config = EncoderConfig::ycbcr(85, ChromaSubsampling::Quarter);
...
///
/// ```rust,ignore
/// use jpegli::heuristics::estimate_decode;
///
...
///
/// ```rust,ignore
/// use jpegli::heuristics::estimate_decode_streaming;
///
