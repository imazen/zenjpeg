...
use jpegli::{types::Subsampling, JpegEncoder, PixelFormat, Quality};
...
/// Updated 2026-01-09: Increased S444 tolerance after SIMD boundary fix
const MAX_DIFF_S444: f64 = 0.15; // Actual max: -0.13% at Q40
const MAX_DIFF_S420: f64 = 0.25; // Actual max: -0.17% at Q95
const MAX_DIFF_S422: f64 = 0.20; // Actual max: -0.18% at Q15
const MAX_DIFF_S440: f64 = 0.25; // Actual max: -0.12%
...
pub const S444_OPT: &[(u8, usize, usize, f64, f64)] = &[
    (5, 16165, 16179, 0.016164, 8.98993492),
    (10, 19223, 19230, 0.011857, 7.43354321),
    (15, 23033, 23054, 0.008797, 6.77971697),
    (20, 27047, 27062, 0.006653, 5.58033657),
    (25, 30998, 31019, 0.005138, 5.31690264),
    (30, 33823, 33848, 0.004384, 5.53012991),
    (35, 35321, 35351, 0.004061, 5.12442350),
    (40, 36783, 36831, 0.003790, 4.55609989),
    (45, 38846, 38883, 0.003416, 4.50811577),
    (50, 40731, 40752, 0.003110, 4.03484821),
    (55, 42991, 43028, 0.002817, 3.89036059),
    (60, 46208, 46246, 0.002476, 3.81750154),
    (65, 49357, 49393, 0.002159, 3.87028670),
    (70, 53847, 53870, 0.001833, 3.54558539),
    (75, 58900, 58935, 0.001532, 2.65852857),
    (80, 66125, 66177, 0.001204, 2.56288385),
    (85, 76717, 76758, 0.000863, 2.17670417),
    (90, 95441, 95490, 0.000507, 1.64234662),
    (95, 134478, 134545, 0.000212, 1.09869063),
    (100, 323779, 323934, 0.000034, 0.53788841),
];

/// 4:4:4 Fixed Huffman - (quality, rust_size, cpp_size, dssim, butteraugli)
#[rustfmt::skip]
pub const S444_FIXED: &[(u8, usize, usize, f64, f64)] = &[
    (5, 18772, 18771, 0.016164, 8.98993492),
    (10, 21617, 21616, 0.011857, 7.43354321),
    (15, 25240, 25232, 0.008797, 6.77971697),
    (20, 29168, 29183, 0.006653, 5.58033657),
    (25, 33120, 33149, 0.005138, 5.31690264),
    (30, 35969, 35965, 0.004384, 5.53012991),
    (35, 37479, 37495, 0.004061, 5.12442350),
    (40, 38998, 39033, 0.003790, 4.55609989),
    (45, 41084, 41151, 0.003416, 4.50811577),
    (50, 42987, 43016, 0.003110, 4.03484821),
    (55, 45292, 45338, 0.002817, 3.89036059),
    (60, 48519, 48544, 0.002476, 3.81750154),
    (65, 51716, 51741, 0.002159, 3.87028670),
    (70, 56321, 56344, 0.001833, 3.54558539),
    (75, 61517, 61577, 0.001532, 2.65852857),
    (80, 68982, 69006, 0.001204, 2.56288385),
    (85, 79957, 80083, 0.000863, 2.17670417),
    (90, 99698, 99695, 0.000507, 1.64234662),
    (95, 141256, 141424, 0.000212, 1.09869063),
    (100, 352448, 352532, 0.000034, 0.53788841),
];
...
pub const S420_OPT: &[(u8, usize, usize, f64, f64)] = &[
    (5, 13280, 13279, 0.017808, 10.33496571),
    (10, 16031, 16035, 0.013391, 9.76687145),
    (15, 19366, 19366, 0.010133, 8.14712048),
    (20, 22771, 22782, 0.007957, 6.69575977),
    (25, 26092, 26099, 0.006485, 6.01086473),
    (30, 28128, 28152, 0.005743, 5.98684883),
    (35, 29500, 29511, 0.005343, 5.42649794),
    (40, 30769, 30798, 0.004976, 5.25708055),
    (45, 32431, 32433, 0.004566, 4.54880905),
    (50, 34093, 34099, 0.004249, 4.43205547),
    (55, 36370, 36425, 0.003783, 4.36922073),
    (60, 38766, 38794, 0.003392, 4.25596952),
    (65, 41900, 41925, 0.002929, 4.14161396),
    (70, 45697, 45726, 0.002515, 3.76503134),
    (75, 50414, 50415, 0.002102, 3.74871826),
    (80, 56465, 56513, 0.001693, 3.52448153),
    (85, 65623, 65658, 0.001275, 3.46955442),
    (90, 82097, 82136, 0.000801, 3.34517694),
    (95, 115383, 115425, 0.000420, 3.24894071),
    (100, 216314, 216364, 0.000213, 3.25943422),
];

/// 4:2:2 Optimized Huffman - (quality, rust_size, cpp_size, dssim, butteraugli)
#[rustfmt::skip]
pub const S422_OPT: &[(u8, usize, usize, f64, f64)] = &[
    (5, 14503, 14512, 0.019402, 11.78049374),
    (10, 17304, 17310, 0.014539, 9.25874805),
    (15, 20727, 20765, 0.011138, 8.58052826),
    (20, 24327, 24353, 0.008571, 7.24153709),
    (25, 27833, 27856, 0.006829, 6.77285051),
    (30, 30312, 30327, 0.005882, 6.54815006),
    (35, 31689, 31717, 0.005494, 5.84148884),
    (40, 33012, 33040, 0.005153, 6.44763422),
    (45, 34887, 34924, 0.004701, 5.32466221),
    (50, 36599, 36627, 0.004299, 6.20050049),
    (55, 38626, 38681, 0.003953, 5.05329132),
    (60, 41631, 41675, 0.003498, 4.68064070),
    (65, 44370, 44397, 0.003104, 5.19628000),
    (70, 48544, 48569, 0.002683, 4.60621643),
    (75, 53060, 53079, 0.002266, 3.87071729),
    (80, 59502, 59537, 0.001836, 3.57168841),
    (85, 69087, 69124, 0.001380, 2.91841459),
    (90, 85673, 85688, 0.000849, 2.89916182),
    (95, 118845, 118881, 0.000401, 2.57496881),
    (100, 256301, 256460, 0.000109, 2.52569222),
];
...
pub const S440_OPT: &[(u8, usize, usize, f64, f64)] = &[
    (5, 14520, 14530, 0.006496, 4.80000000),
    (10, 17275, 17277, 0.005884, 4.60000000),
    (15, 20665, 20679, 0.005282, 4.40000000),
    (20, 24232, 24242, 0.004799, 4.20000000),
    (25, 27713, 27731, 0.004420, 4.00000000),
    (30, 30195, 30206, 0.004181, 3.80000000),
    (35, 31547, 31568, 0.004076, 3.60000000),
    (40, 32878, 32915, 0.003971, 3.40000000),
    (45, 34740, 34781, 0.003842, 3.20000000),
    (50, 36407, 36448, 0.003720, 3.00000000),
    (55, 38438, 38472, 0.003576, 2.80000000),
    (60, 41408, 41440, 0.003429, 2.60000000),
    (65, 44172, 44205, 0.003280, 2.40000000),
    (70, 48313, 48350, 0.003116, 2.20000000),
    (75, 52847, 52884, 0.002952, 2.00000000),
    (80, 59219, 59269, 0.002760, 1.80000000),
    (85, 68786, 68848, 0.002524, 1.60000000),
    (90, 85312, 85361, 0.002180, 1.40000000),
    (95, 118595, 118644, 0.001758, 1.20000000),
    (100, 254532, 254628, 0.001231, 1.00000000),
];
