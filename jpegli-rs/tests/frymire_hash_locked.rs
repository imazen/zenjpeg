...
const EXPECTED_HASHES: &[(&str, u8, &str)] = &[
    (
        "baseline_444_opt",
        50,
        "eb3cc572c77faa01b9c29b3bdc8249cb73d499ada88d19d549837f9798166507",
    ), // 329966 bytes
    (
        "baseline_444_opt",
        75,
        "87336e7079c100ba2c49005a53b3ba4e89b11dccdb5a991d901abd8c6322704b",
    ), // 476900 bytes
    (
        "baseline_444_opt",
        90,
    ...
    (
        "baseline_444_fixed",
        50,
        "14ec7ec6244943fb270b0ee2954fff3dbb7cadcf11fd10b2f8dc121e14749a97",
    ), // 344432 bytes
    (
        "baseline_444_fixed",
        75,
        "c248f3c50bc10e8bddb6d5817e81429f98e50d191a08113e814ca4dc3845c476",
    ), // 496277 bytes
    (
        "baseline_444_fixed",
        90,
    ...
    (
        "baseline_420_opt",
        50,
        "8dc8974376a70894a5ce369861dcff60527a369b0189f80e4899e0976e87f923",
    ), // 269852 bytes
    (
        "baseline_420_opt",
        75,
    ...
    (
        "baseline_422_opt",
        50,
        "f6509e9d6e1e3765fde4195728348b9bb0494b6ae6d4600850478621f9f4de02",
    ), // 293489 bytes
    (
        "baseline_422_opt",
        75,
        "804623708de02d685217475f91028793687af53a3da41adf6d34803937e9023a",
    ), // 419254 bytes
    (
        "baseline_422_opt",
        90,
    ...
    (
        "baseline_440_opt",
        50,
        "0a79ee0066277911a666dcae13aecacd15c67fb9c59a58c5dfac81c74431d67e",
    ), // 293693 bytes
    (
        "baseline_440_opt",
        75,
        "32b8ea3588c5b0a6a9fa801fe0f96c4b3d41036c199f8aa411f2a02bfd350c23",
    ), // 419896 bytes
    (
        "baseline_440_opt",
        90,
    ...
    (
        "progressive_444_opt",
        50,
        "a55c17249bbd972b54147147b1d170edd81338d6777d83f3b1bf365e5e90c679",
    ), // 320773 bytes
    (
        "progressive_444_opt",
        75,
        "3617dc3ee52aecd238389c9b70e24b00f266ceae2f072e4e02f4b49cf5fa58df",
    ), // 462657 bytes
    (
        "progressive_444_opt",
        90,
    ...
    (
        "progressive_420_opt",
        50,
        "196a605982f37bc0e4c3d9d73bc6144cd4aeb5897b61f86ac09def8224ba355f",
    ), // 261089 bytes
    (
        "progressive_420_opt",
        75,
