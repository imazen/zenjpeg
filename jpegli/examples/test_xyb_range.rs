...
fn main() {
    ...
    for (r, g, b) in test_values {
        ...
        println!("({:3}, {:3}, {:3}) -> {:12.4} {:12.4} {:12.4}", r, g, b, x, y, b_out);
    ...
    println!("X: [{:.4}, {:.4}] (range: {:.4})", min_x, max_x, max_x - min_x);
    println!("Y: [{:.4}, {:.4}] (range: {:.4})", min_y, max_y, max_y - min_y);
    println!("B: [{:.4}, {:.4}] (range: {:.4})", min_b, max_b, max_b - min_b);
}
