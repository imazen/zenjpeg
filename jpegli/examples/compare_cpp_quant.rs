...
fn main() {
    ...
    let cpp_cbcr_table: [u16; 64] = [
        5, 11, 16, 19, 19, 30, 32, 51,
        11, 15, 16, 24, 29, 29, 47, 37,
        16, 16, 19, 32, 34, 42, 179, 43,
        19, 24, 32, 32, 28, 44, 44, 62,
        19, 29, 34, 28, 34, 26, 35, 89,
        30, 29, 42, 44, 26, 54, 81, 117,
        32, 47, 179, 44, 35, 81, 107, 154,
        51, 37, 43, 62, 89, 117, 154, 195,
    ];
